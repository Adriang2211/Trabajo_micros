...
/* Clock_2 */
#define Clock_2__DIV_IDX 0
#define Clock_2__DIV_NUM 0
#define Clock_2__DIV_TYPE CY_SYSCLK_DIV_8_BIT

/* Encoder */
#define Encoder_TCPWM__CNT_HW TCPWM1_CNT0
#define Encoder_TCPWM__CNT_IDX 0u
#define Encoder_TCPWM__HW TCPWM1
#define Encoder_TCPWM__IDX 1u
...
/* Counter_2 */
#define Counter_2_TCPWM__CNT_HW TCPWM0_CNT0
#define Counter_2_TCPWM__CNT_IDX 0u
...
#define CY_PROJECT_NAME "Trabajo_test_control_fase_v2"
