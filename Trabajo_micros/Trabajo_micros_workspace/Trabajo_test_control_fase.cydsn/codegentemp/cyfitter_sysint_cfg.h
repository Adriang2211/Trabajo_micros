...
/* ARM CM4 */
    ...
    #define Timer2_int__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t Timer2_int_cfg;

    #define Opto_detec__INTC_ASSIGNED 1u
    extern const cy_stc_sysint_t Opto_detec_cfg;
