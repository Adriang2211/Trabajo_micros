...
# Date: Tue, 29 Apr 2025 22:32:56 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/periclk}] -edges {1 501 1001} [list [get_pins {ClockBlock/ff_div_12}] [get_pins {ClockBlock/ff_div_13}] [get_pins {ClockBlock/ff_div_14}] [get_pins {ClockBlock/ff_div_15}] [get_pins {ClockBlock/ff_div_16}]]
