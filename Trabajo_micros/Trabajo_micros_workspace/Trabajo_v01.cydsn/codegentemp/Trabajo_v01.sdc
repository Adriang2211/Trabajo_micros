...
# Date: Sun, 13 Apr 2025 10:59:31 GMT
#set_units -time ns
...
create_generated_clock -name {Clock_1} -source [get_pins {ClockBlock/periclk}] -edges {1 501 1001} [list [get_pins {ClockBlock/ff_div_12}] [get_pins {ClockBlock/ff_div_13}]]
