...
/* Boton */
#define Boton_0_DRIVEMODE CY_GPIO_DM_PULLUP
#define Boton_0_INBUF_ENABLED 1u
#define Boton_0_INIT_DRIVESTATE 1u
#define Boton_0_INIT_MUXSEL 0u
#define Boton_0_INPUT_SYNC 2u
#define Boton_0_INTERRUPT_MODE CY_GPIO_INTR_FALLING
#define Boton_0_NUM 2u
#define Boton_0_PORT GPIO_PRT5
#define Boton_0_SLEWRATE CY_GPIO_SLEW_FAST
#define Boton_0_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
#define Boton_DRIVEMODE CY_GPIO_DM_PULLUP
#define Boton_INBUF_ENABLED 1u
#define Boton_INIT_DRIVESTATE 1u
#define Boton_INIT_MUXSEL 0u
#define Boton_INPUT_SYNC 2u
#define Boton_INTERRUPT_MODE CY_GPIO_INTR_FALLING
#define Boton_NUM 2u
#define Boton_PORT GPIO_PRT5
#define Boton_SLEWRATE CY_GPIO_SLEW_FAST
#define Boton_THRESHOLD_LEVEL CY_GPIO_VTRIP_CMOS
